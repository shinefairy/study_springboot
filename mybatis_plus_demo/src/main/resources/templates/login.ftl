...
<head>
    ...
    <link rel="stylesheet" href="${basePath!}/demo/layui/css/layui.css" media="all"/>
</head>
...
<form class="layui-form">
    ...
    <div class="layui-form-item input-item" id="imgCode">
        ...
        <input type="text" placeholder="请输入验证码" id="imageCode" name="imageCode" autocomplete="off" id="code"
               class="layui-input">
        <#--验证码通过接口获取-->
        <img id="imgObj" title="看不清，换一张" src="${basePath!}/demo/getKaptchaImage" onclick="this.src='${basePath!}/demo/getKaptchaImage?d='+new Date().getTime()"/>
    </div>
...
<script type="text/javascript" src="${basePath!}/demo/layui/layui.js"></script>
